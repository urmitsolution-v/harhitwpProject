        ...
        <script>
            $(document).ready(function() {
                ...
                $("#datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('contactenquires') }}", // URL for AJAX data
                    ...
                    columns: [
                        ...
                        { data: 'name', name: 'name' }, // Title column
                      // Image column
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Contact Enquires</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Contact Enquires</li>
                            </ol>
                        </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" id="contactModalBody">
        <!-- Contact data will be populated here by JavaScript -->
...
<script>
    function viewContact(name, email, message, phone , createdAt) {
    let html = `
        <ul class="list-group">
            ...
            <li class="list-group-item"><strong>Created At:</strong><br>${createdAt}</li>
        </ul>
    `;
    document.querySelector('#contactModalBody').innerHTML = html;
}</script>
