...
@section('title', 'Create Case Studio - ')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">New Case Studio</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" required name="title" value="{{ old('title') }}" id="sluggenrate" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  name="client" class="form-control" id="cientinput"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date"  name="date" class="form-control" id="locationinput"
                                                    placeholder="">
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  name="budget" class="form-control" id="locationinput"
                                                    placeholder="">
                                            </div>
                                        </div>
