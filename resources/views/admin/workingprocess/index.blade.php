        ...
        <script>
            $(document).ready(function() {
                ...
                $("#datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('processwork.about') }}", // URL for AJAX data
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Working Process</h4>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        <a href="/admin/create-working-proces" class="btn btn-primary">Create New</a>
                        <a href="/admin/edit-page/30" class="btn btn-success">Page CMS</a>
                    </div>
                </div>
