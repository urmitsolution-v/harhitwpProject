                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="{{ $row->phone }}"  placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="email" value="{{ $row->email }}"  placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label for="contact_phone" class="form-label">Footer Address</label>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="" class="form-control" cols="30" name="location_iframe" rows="5">{{ $row->location_iframe }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="twitter" value="{{ $row->twitter }}" id="title" placeholder="">
                                                </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="linkedin" value="{{ $row->linkedin }}" id="title" placeholder="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="instagram" value="{{ $row->instagram }}" id="title" placeholder="">
                                                    </div>
