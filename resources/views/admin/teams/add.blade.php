                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">New Team</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" required name="name" value="{{ old('name') }}"  placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="sub_title" value="{{ old('sub_title') }}" id="sluggenrate" placeholder="">
                                            </div>
                                        </div>
                                       ...
                                       <div class="col-md-6">
                                                    <div class="mb-3">
                                                       ...
                                                       <select name="team_type" class="form-select" id="">
                                                        <option value="is_team">Teams</option>
                                                        <option value="investment_committee">Investment Committee</option>
                                                        <option value="technical_adviser">Technical Advisors</option>
                                                       </select>
                                                       @error('status')
                                                       <div class="text-danger mt-1">{{ $message }}</div>
                                                   @enderror
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="bio" id="editor" cols="30" rows="5" class="form-control">{{ old('bio') }}</textarea>
                                            </div>
                                        </div>
