...
@section('footer')
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('teams-list') }}", // URL for AJAX data
                    ...
                    columns: [
                        ...
                        { data: 'sub_title', name: 'sub_title' }, // Title column
        ...
        return '<span class="badge bg-danger">Inactive</span>';
                        ...
                        { data: 'team_type', name: 'team_type', orderable: false, searchable: false }, // Action buttons
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        <a href="/admin/new-team" class="btn btn-primary">New Team</a>
                        <a href="/admin/edit-page-team" class="btn btn-info">Page Setting & Seo</a>
                    </div>
                </div>
                <div class="col-12">
                    <div class="card">
