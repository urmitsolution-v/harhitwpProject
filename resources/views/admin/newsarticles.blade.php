        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">News & Articles</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">News & Articles Details</h4>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <div id="lists_content">
                                                ...
                                                @else
                                                    <div class="listitem d-flex mb-2">
                                                        <input type="text" name="title[]" class="form-control" onkeyup="slugGenrate(this)" placeholder="Enter title">
