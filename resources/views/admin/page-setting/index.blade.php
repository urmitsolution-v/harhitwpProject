        ...
        <script>
            $(document).ready(function() {
                ...
                $("#datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('seomanagement') }}", // URL for AJAX data
                    ...
                    columns: [
                        ...
                        { data: 'pagename', name: 'pagename' }, // Title column
                        { data: 'updated_at', name: 'updated_at' }, // Title column
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">My Pages & SEO Management</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">My Pages & SEO Management</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <!--<div class="col-12">-->
                <!--    <div class="mb-3">-->
                <!--        <a href="/admin/new-page" class="btn btn-primary">New Page & Section</a>-->
                <!--    </div>-->
                <!--</div>-->
