        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">New Page</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">New Page Details</h4>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pagename" value="{{ old('pagename') }}" id="slugbox" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="bradcump_title" value="{{ old('bradcump_title') }}" id="sluggenrate" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pagetitle" value="{{ old('pagetitle') }}" id="slugbox" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pagesubtitle" value="{{ old('pagesubtitle') }}" id="slugbox" placeholder="">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="short_desc"  cols="30" rows="3" placeholder="Description" class="form-control "></textarea>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="meta" value="{{ old('meta') }}" id="title" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="tag" value="{{ old('tag') }}" id="title" placeholder="">
                                        </div>
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label for="title" class="form-label">Meta Description</label>
                                        <textarea name="meta_d" cols="10" rows="2" placeholder="Description" class="form-control">{{ old('meta_d') }}</textarea>
                                    </div>
