                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Eligibility Banner</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <form method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="buttonName" value="{{ $row->buttonName ?? "" }}" id="title" placeholder="">
                                    </div>
                                     </div>
                              ...
                              <div class="col-md-6">
                                            <div class="mb-3 ">
                                                ...
                                                <input type="file" accept="image/*" name="image" class="form-control" id="formrow-firstname-input"
                                                    placeholder="">
                                                    @if ($data->image)
                                                    <div class="bg-light p-2 rounded img-thumbnail mt-4" style="max-width: max-content">
