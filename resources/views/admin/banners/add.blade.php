...
<style>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">New Hero Section</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
    ...
    <div class="row">
        <div class="col-md-6 rowminus">
            ...
            {{-- Title --}}
            <div class="mb-3">
                <label for="sluggenrate" class="form-label">Title</label>
        ...
        <div class="col-md-6 mb-3">
         {{-- <div class="mb-3">
            ...
            <textarea name="description" cols="30" rows="10" placeholder="Description" class="form-control editor">{{ old('description') }}</textarea>
            @error('description')
                <div class="text-danger mt-1">{{ $message }}</div>
            @enderror
         </div> --}}
