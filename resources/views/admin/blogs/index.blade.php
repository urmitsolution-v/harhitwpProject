        ...
        <script>
            $(document).ready(function() {
                ...
                $("#datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('blogsAdmin') }}", // URL for AJAX data
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        <a href="/admin/create-blog" class="btn btn-primary">New Blog</a>
                        <a href="/admin/edit-page-blog" class="btn btn-info">Page Setting & Seo</a>
                    </div>
                </div>
