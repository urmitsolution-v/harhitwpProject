        ...
        <script>
            $(document).ready(function() {
                ...
                $("#datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('testimonials') }}", // URL for AJAX data
                    ...
                    columns: [
                        ...
                        { data: 'destination', name: 'destination' }, // Title column
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        <a href="/admin/create-testimonials" class="btn btn-primary">New Testimonials</a>
                    </div>
                </div>
