            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Update Testimonial</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{ $row->name }}" id="sluggenrate" placeholder="">
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="destination" value="{{ $row->destination }}" id="slugbox" placeholder="">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="description" id="editor" cols="30" rows="3" placeholder="Description" class="form-control editor">{{ $row->description }}</textarea>
                                    </div>
