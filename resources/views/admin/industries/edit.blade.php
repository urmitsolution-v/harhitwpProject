            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Update Industry</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Industry Details</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="post_title" value="{{ $row->post_title }}"  placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="title" value="{{ $row->title }}" id="sluggenrate" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="cmstitle" value="{{ $row->cmstitle }}" id="sluggenrate" placeholder="">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" accept="image/*" name="image" class="form-control" id="formrow-firstname-input"
                                                    placeholder="">
                                                      @if($row->image)
                                                        <img class="uploadedimage img-thumbnail" src="{{ url('') }}/uploads/{{ $row->image }}"  alt="">
                                                    @endif
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="faq_status" class="form-control" id="">
                                                            <option value="Y"  <?= $row->faq_status == "Y" ? "selected" : "" ?>>Yes</option>
                                                            <option value="N"  <?= $row->faq_status == "N" ? "selected" : "" ?>>No</option>
                                                        </select>
                                                        @error('status')
                                                        <div class="text-danger mt-1">{{ $message }}</div>
                                                        @enderror
