  ...
  <div class="bg">
    <div class="container mt-1">
      <div class="d-flex no-gutter clearfix">
        <div class="d-flex flex-wrap align-items-center col-md-6 col-lg-6 quick-links">
          <div class="container" style="margin-top:65px;">
            <div class="row">
              <a href="../wp-content/uploads/hh-assets/application-form-for-HAICL-Franchisee.pdf" target="_blank" class="btn btn-lg btn-block btn-links m-3">Download IOCL Franchisee Application<br>( आईओसीएल फ्रैंचाइज़ी एप्लिकेशन डाउनलोड करें )</a>
            </div>
            <div class="row">
              <button class="btn btn-lg btn-block btn-links m-3 eligibility_btn" type="button"> Eligibility
                to Apply New
                Franchisee</button>
            </div>
            <div class="row">
            ...
            <div class="row">
              <a href="../wp-content/uploads/hh-assets/faq-hindi.pdf" target="_blank" class="btn btn-lg btn-block btn-links m-3">Asked Questions ( Hindi )</a>
            </div>
          </div>
          <div class="container">
        ...
        <div class="col-md-6 col-lg-6">
          <div class="login d-flex align-items-center py-2 pt-2">
            <div class="container">
              <div class="row">
                <div class="col-md-11 col-lg-11 mx-auto">
                  <div class="text-center">
                    <h5 class="title mb-2">— Apply for <img src="{{ url('website/auth') }}/images/harhith-blk-logo.svg" height="35px"> Franchisee —</h5>
                    <p class="subtitle">Please login to continue Franchisee application process</p>
                  </div>
                  <hr>
                  <form id="signup" class="form-signin" action="#" method="post">
                    <div class="form-group">
                      <label>Family ID ( परिवार पहचान पत्र )</label>
                      <input type="text" id="family-card-id" class="form-control" name="family-card-id" placeholder="Family Member ID" autocomplete="off" autofocus>
                    </div>
                    <div class="form-group">
                      <label>Name as in Aadhaar Card ( आधार कार्ड में नाम )<span class="text-danger">*</span></label>
                      <input type="text" id="name" class="form-control" name="name" required placeholder="Name as in Aadhaar Card" autocomplete="off" autofocus>
                    </div>
                    <div class="form-group">
                      <label>Mobile Number ( मोबाइल नंबर ) <span class="text-danger">*</span></label>
                      <input type="number" id="mobile-no" name="mobile-no" class="form-control" required autocomplete="off" placeholder="Enter Mobile Number *">
                    </div>
                    <div class="form-group email-err">
                      <label>Email Address ( ईमेल )<span class="text-danger"> *</span></label>
                      <input type="text" id="email" name="email" required class="form-control" autocomplete="off" placeholder="Email Address">
                    </div>
                    <div class="form-group">
                      <label>District ( जिला )<span class="text-danger">*</span></label>
                      <select class="custom-select" required id="district" name="district">
                        <option value="">Choose...</option>
                                                  <option value="02">AMBALA</option>
                                                  <option value="13">BHIWANI</option>
                                                  <option value="22">CHARKHI-DADRI</option>
                                                  <option value="20">FARIDABAD</option>
                                                  <option value="10">FATEHABAD</option>
                                                  <option value="18">GURUGRAM</option>
                                                  <option value="12">HISAR</option>
                                                  <option value="15">JHAJJAR</option>
                                                  <option value="09">JIND</option>
                                                  <option value="05">KAITHAL</option>
                                                  <option value="06">KARNAL</option>
                                                  <option value="04">KURUKSHETRA</option>
                                                  <option value="16">MAHENDERGARH</option>
                                                  <option value="19">NUH</option>
                                                  <option value="21">PALWAL</option>
                                                  <option value="01">PANCHKULA</option>
                                                  <option value="07">PANIPAT</option>
                                                  <option value="17">REWARI</option>
                                                  <option value="14">ROHTAK</option>
                                                  <option value="11">SIRSA</option>
                                                  <option value="08">SONIPAT</option>
                                                  <option value="03">YAMUNANAGAR</option>
                                              </select>
                    </div>
                    <!--<div class="form-group">
                      <label>Tehsil <span>*</span></label>
                      <select class="custom-select" required id="tehsil" name="tehsil">
                        <option value="">Choose...</option>
                      </select>
                    </div>-->

                    <button class="btn btn-lg btn-block btn-signup" type="submit"> Generate OTP</button>
                    <span class="d-block text-center mt-2">Already have an account ? <a href="login.html">Login here</a></span>
                  </form>
                </div>
              </div>
            </div>
    ...
    $(function() {
      ...
      $('#signup').validate({
        rules: {
          'family-card-id': {
            required: false,
            family_card_id_checker: true,
            minlength: 8,
            maxlength: 8,
            remote: {
              url: "include/verifyFamilyID.php",
              type: "post"
            }
          },
          name: {
        ...
        messages: {
          ...
          'mobile-no': {
            remote: "Mobile no already Registered !. Please try to Login",
            ind_mobile: "Please enter valid mobile number",
          ...
          'family-card-id': {
            family_card_id_checker: "Invalid Family ID",
            remote: "Family Id Not Found"
          }
        },
        errorPlacement: function(error, element) {
          if (element.is(":radio")) {
            ...
            error.appendTo(element.parents('.email-err'));
          } else {
...
<!-- Mirrored from harhith.com/harhith_forms/registration.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Aug 2025 07:04:29 GMT -->
</html>
