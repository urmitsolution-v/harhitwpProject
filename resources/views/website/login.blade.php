...
<!-- Mirrored from harhith.com/harhith_forms/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Aug 2025 07:05:00 GMT -->
...
<head>
    ...
    <title>Login</title>
    <link rel="icon" href="{{ url('website/auth') }}/images/favicon.png">
    <link rel="apple-touch-icon" href="{{ url('website/auth') }}/images/apple-touch-icon.png">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('website/auth') }}/css/yearpicker.css">
        ...
        <div class="container d-flex  align-items-center justify-content-center justify-content-md-between">
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul id="sidenav" class="sidenav">
                    ...
                    <li><a href="../contact-us/index.html" class="redirectable"><span>Contact Us</span></a>
                    </li>
                </ul>
            </nav><!-- .navbar -->

            <div class="logout_block">
                                        <a class="btn" href="/franchise-registration"><span class=" d-md-inline">Register</span></a>
...
<!--<div class="header_section">
    <nav class="navbar navbar-light">
        <a class="navbar-brand" href="index.php">
            <img src='{{ url('website/auth') }}/images/harhit-logo.svg' class="harit_logo" />
        </a>
        <button class="navbar-toggler" type="button" onclick="openNav()" style="border: none;">
            <img src="{{ url('website/auth') }}/images/combined-shape.svg" style="width: 70%;">
        </button>
    </nav>
</div>-->
    <div class="bg">
        <div class="container mt-5">
            <div class="d-flex no-gutter clearfix">
                <div class="d-flex flex-wrap align-items-center col-md-6 pt-2 col-lg-6 quick-links">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="row">
                            <button class="btn btn-lg btn-block btn-links m-3 eligibility_btn" type="button">Eligibility to Apply New Franchisee</button>
                        </div>
                        <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="login d-flex align-items-center pt-2 mb-2">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8 col-lg-8 mx-auto">
                                    <div class="text-center">
                                        <h5 class="title mb-2">-- Login --</h5>
                                    ...
                                    <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="mobile-no" class="form-control" maxlength="10" minlength="10" required name="mobile-no" value="" autocomplete="off" class="form-control" placeholder="Enter Mobile Number *" autofocus maxlength="10">
                                        </div>
                                        <button class="btn btn-lg btn-block btn-signup mb-3" id="signin-submit" type="submit" > Generate
                                            OTP</button>
                                    </form>
                                    <form id="otp-form" class="form-signin" action="#" method="post">
                                        <div class="form-group">
                                            <div class="d-flex flex-row align-items-center justify-content-center">
                                                <input type="number" class="otp-box" maxLength="1" id="otp-1" name="otp-1" autocomplete="off" autofocus disabled>
                                                <input type="number" class="otp-box" maxLength="1" id="otp-2" name="otp-2" autocomplete="off" disabled>
                                                <input type="number" class="otp-box" maxLength="1" id="otp-3" name="otp-3" autocomplete="off" disabled>
                                                <input type="number" class="otp-box" maxLength="1" id="otp-4" name="otp-4" autocomplete="off" disabled>
                                            </div>
                                            <div class="text-center" id="otp-err"></div>
                                        </div>
                                        <div id="otp-timer" class="text-center">
                                            <span id="timer"></span>
                                        </div>

                                        <button class="btn btn-lg btn-block btn-signup" id='submit-otp' type="submit" disabled> Submit
                                            OTP</button>
                                    </form>
                                </div>
                            </div>
    ...
    <!--FOOTER-->
    <!--.....................................................................................-->
    <script type="text/javascript" src="fontawesome/{{ url('website/auth') }}/js/all.min.js"></script>
        ...
        "use strict";
            ...
            $('#signin').validate({
                rules: {
                    'mobile-no': {
                        ...
                        ind_mobile: true,
                        remote: {
                            url: "include/isMobileRegistered.php",
                            type: "post"
                        },
                ...
                messages: {
                    'mobile-no': {
                        ...
                        remote: "Mobile No. is not yet registered, Please Register.",
            ...
            $('#otp-form').validate({
                ...
                errorPlacement: function(error, element) {
                    ...
                    } else if (element.attr("name") == "otp-1" || element.attr("name") == "otp-2" || element.attr("name") == "otp-3" || element.attr("name") == "otp-4") {
                        error.appendTo("#otp-err");
                    } else {
