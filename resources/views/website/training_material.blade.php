...
<div class="site-content col-lg-12 col-12 col-md-12" role="main">
		...
		<div id="wd-61065587a1eae" class="title-wrapper wd-wpb set-mb-s reset-last-child  wd-title-color-primary wd-title-style-default wd-width-100 text-center vc_custom_1627805069028">
							<div class="title-subtitle  subtitle-color-primary font-default subtitle-style-default wd-font-weight- wd-fontsize-xs">Harhith</div>
		...
		<div class="vc_row wpb_row vc_inner vc_row-fluid traning_videos"><div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner"><div class="wpb_wrapper">
	<div class="wpb_video_widget wpb_content_element vc_clearfix vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-left" >
		<div class="wpb_wrapper">
			<h2 class="wpb_heading wpb_video_heading">Har-Hith - A Modern Retail Expansion Project</h2>
			<div class="wpb_video_wrapper"><iframe title="Har-Hith - A Modern Retail Expansion Project" width="500" height="281" src="https://www.youtube.com/embed/B4xO6EA-lTc?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
		</div>
	</div>
</div></div></div><div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner"><div class="wpb_wrapper">
	<div class="wpb_video_widget wpb_content_element vc_clearfix vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-left" >
		<div class="wpb_wrapper">
			<h2 class="wpb_heading wpb_video_heading">HarHith Franchise Form Tutorial</h2>
			<div class="wpb_video_wrapper"><iframe loading="lazy" title="Har-Hith Franchise Form Tutorial" width="500" height="281" src="https://www.youtube.com/embed/OQq7ynRQh0s?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
		</div>
	</div>
</div></div></div><div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner"><div class="wpb_wrapper">
	<div class="wpb_video_widget wpb_content_element vc_clearfix vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-left" >
		<div class="wpb_wrapper">
			<h2 class="wpb_heading wpb_video_heading">Har-Hith - Website Navigation Video</h2>
			<div class="wpb_video_wrapper"><iframe loading="lazy" title="HarHith - Website Navigation" width="500" height="281" src="https://www.youtube.com/embed/WPvLSpVlez0?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
		</div>
	</div>
